...
public class OmaMoottori extends Moottori {
	...
	protected void alustukset() {
		// saapumisprosessi.generoiSeuraava(); // EnsimmÃ¤inen saapuminen
		// jÃ¤rjestelmÃ¤Ã¤n
	...
	public String tulostustoString() {
		...
		tuloste = "Luodut opiskelija: " + luodut + 
				"\nKeskimääräinen tyytyväisyys: " + avgtyytyvaisyys + 
				"\nKeskimääräinen jonotusaika: " + keskimaarainenJonotus + 
				...
				"\nBaarien määrä: " + palvelupisteidenMaara + 
				"\nOpiskelijoiden määrä: " + montaOpiskelijaa + 
...
/*
	...
	public void aloitusPaikka(Palvelupiste p[]) {
		...
		// mï¿½ï¿½rï¿½llï¿½.
		// VARIANCE on opiskelijoiden mï¿½ï¿½rï¿½ jaettuna kaksinkertainen
		// baarienmï¿½ï¿½rï¿½
		//
	...
	public void ulos(Palvelupiste p[]) {
		Asiakas a = p[0].otaSisalta(); // poistaa tï¿½llï¿½ hetkellï¿½ vain asiakkaat jï¿½rjestelmï¿½stï¿½ lopullisesti
